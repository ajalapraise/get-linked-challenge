...
const contact: React.FC<FormState> = () => {
    ...
    return (
        <div className={`  justify-evenly relative items-center px-10 md:px-20 py-10 md:py-24 border-b-[1px] min-h-screen border-[#FFFFFF2E] w-full`}>
            <div className="w-full md:p-5  h-[670px] justify-center items-center ">
                <div className={`md:p-5 flex flex-col md:justify-between md:items-center  md:flex-row-reverse  md:w-full `}>
                    ...
                    <div className={`flex md:border-[1px]  md:border-[blue]  md:w-[650px] md:justify-center md:items-center md:px-5 md:py-14 shadow-md`}>
                        <div className={`flex flex-col space-y-7  md:justify-center md:items-start `}>
                    ...
                    <div className="md:w-1/4 md:px-5 space-y-6">
                        <div className={`hidden md:flex md:flex-col space-y-7  text-[white]`}>
                            ...
                            <h3 className="text-base w-[100px] font-extrabold">27,Alara Street, Yaba 100012, Lagos State</h3>
